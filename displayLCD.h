...
#define TRIS_RS  	TRISDbits.RD1
#define TRIS_E   	TRISDbits.RD0
#define TRIS_RW	 	TRISDbits.RD2

// Define o valor dos delays baseado no clock da CPU de 20 MHz
#define DELAY_SINC()	Delay1KTCYx(5)		// Delay de 1ms para Fosc=20MHz
											// Geralmente 1ms é suficiente, mas
											// depende do controlador do display
											// Aumente conforme a necessidade!
											
#define DELAY_5ms()		Delay10KTCYx(3)		// Delay de 6ms para Fosc=20MHz
